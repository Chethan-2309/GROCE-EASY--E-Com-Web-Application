...
<body>
  ...
  <div class="td-search-popup" id="td-search-popup">
    <form action="https://s7template.com/tf/carace/home.html" class="search-form">
  ...
  <section class="vh-100" style="background-color:orange;">
    <div class="container py-5 h-100">
      <div class="row d-flex justify-content-center align-items-center h-100">
        <div class="col">
          <?php
          $stmt2 = $admin->ret("SELECT * FROM `order` INNER JOIN `product` ON order.p_id=product.p_id WHERE order.r_id='$cid' ORDER BY order.or_id DESC");
          $c=$stmt2->rowCount();
          ...
          ?>
            <div class="card card-stepper mt-2" style="border-radius: 10px;">
              ...
              <div class="card-body p-4">
                ...
                // $row4 = $stmt4->fetch(PDO::FETCH_ASSOC);
                  ...
                  ?>
                    <div class="d-flex flex-column">
                      ...
                      <span class="text">Quantity: <?php echo $row['or_quantity'] ?> x <?php echo $row['p_price'] ?> = <?php echo $total ?></span>
                    </div>
                 
                  <div>
                    <?php if ($b_status == 'order_accepted') { ?>
                      <button class="btn btn-success" left >Accepted</button>
                  ...
                  <div>
                    <?php if ($b_status == 'order_canceled') { ?>
                ...
                <div class="d-flex flex-row justify-content-between align-items-center align-content-center">
                  <?php if ($b_status == 'Picked by courier') { ?>
                    <span class="dot"></span>
