        ...
        <div class="row">
          ...
          <div class="col-md-8 order-md-1 border">
            ...
            <div class="row">
              <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control" id="firstName" placeholder="" value="" required name="fname" pattern="[a-zA-Z\s]*" title="Please Enter the Characters" required>
              ...
              <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control" id="lastName" placeholder="" value="" pattern="[a-zA-Z\s]*" title="Please Enter the Characters" required name="lname">
                <div class="invalid-feedback">
          ...
          <div class="input-group">
            ...
            <div class="mb-3">
              ...
              <input type="tel" class="form-control" id="email" placeholder="" required name="phone" pattern="{10}" title="Please Enter the 10 digit phone number" required/>
              <div class="invalid-feedback" >
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="address" placeholder="" required name="address" pattern="[a-zA-Z\s]*" title="Please Enter the Characters" required/>
              <div class="invalid-feedback">
            ...
            <div class="invalid-feedback">
              ...
              <div class="col-md-4 mb-3">
                ...
                <input type="text" class="form-control" id="state" placeholder="" required name="state" pattern="[a-zA-Z\s]*" title="Please Enter the Characters" required/>
              ...
              <div class="col-md-3 mb-3">
                ...
                <input type="text" class="form-control" id="zip" placeholder="" required name="zip" pattern="{6}" title="Please Enter the 6 digit Valid Pincode" required/>
                <div class="invalid-feedback">
                  Zip code required.
                </div>
              </div>
                  ...
                  <div class="container d-flex  main">
                    <div class="card">
                      ...
                      <div class="d-flex justify-content-between px-3 pt-4">
                        ...
                        <div><label for="cvv" class="cvvtxt">CVV / CVC</label><input type="text" name="cvv" class="form-control cvv" placeholder="CVV / CVC" id="exp" minlength="3" maxlength="3" >
                          <div class="invalid-feedback">
          ...
          <div class="col-md-6 mb-3">
            ...
            <!-- <div class="row">
          <div class="col-md-3 mb-3">
            <label for="cc-expiration">Expirsation</label>
