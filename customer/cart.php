...
$stmt1=$admin->ret("SELECT COUNT(*) FROM `cart` WHERE `r_id`='$cus_id' ");
...
<div class="card" id="ajax_table"   >
            <div class="row">
                ...
                ?>
                            ...
                            <div class="col">
                            <div class=""style="margin-left: 70px;"><a href="controller/deletecart.php?cusid=<?php echo $row['c_id']?>"><i class="fa fa-times fa-2x"  aria-hidden="true"></i></a></div>
                            </div>
                   ...
                   <?php } ?>
                    ...
                    <div class="back-to-shop"><a href="menu.php"><button class="btn btn-primary"> <i class="fa fa-arrow-left" aria-hidden="true"></i> Back to shop</button></a></div>
                </div>
                ...
                <div class="col-md-4 summary text-red">
                    ...
                    <?php 
                    $stmt2=$admin->ret("SELECT * FROM `owner`INNER JOIN   `product` ON product.o_id=owner.o_id");
